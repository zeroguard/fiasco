...
ABOUT_FILE = os.path.join(BASE_DIR, 'fiasco', '__version__.py')
...
def main():
    ...
    # Setup the package
    setup(
        name=fiasco.__title__,
        version=fiasco.__version__,
        license=fiasco.__license__,

        description=fiasco.__description__,
        long_description=readme,
        long_description_content_type='text/markdown',

        author=fiasco.__author__,
        author_email=fiasco.__author_email__,
        url=fiasco.__home_url__,
